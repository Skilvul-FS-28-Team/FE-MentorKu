...
import { FaDribbble, FaInstagram, FaLinkedin, FaYoutube } from "react-icons/fa";
      ...
      <div className="container" id="hero">
        <div className="hero-section">
          <div className="hero-text">
            <img
              src="src/assets/img/mentor/Profile mentor.png"
              alt="MentorKu"
            />
            <div className="hero-desc">
              <h2>
                Lina Wiona <span>Product Designer di Tokopedia</span>
              </h2>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text" id="desc-text">
                  Haloo Semua Salam Kenal Saya bekerja sebagai Arsitek Teknis di
                  salah satu ECommerce terbesar di Indonesia. Saya memiliki
                  lebih dari 10 tahun pengalaman membangun Aplikasi di
                  Perusahaan Startup dan Korporat. Saya tunggu kamu pada sesi
                  mentoring ! Saya juga Content Creator di Programmer Zaman Now.
                  Anda dapat melihat banyak tutorial tentang Pemrograman, Web,
                  Backend, Frontend, Mobile dan DevOps di Programmer Zaman Now.
                  Untuk informasi lebih lanjut tentang Programmer Zaman Now bisa
                  dilihat di Website, Channel Youtube, atau Sosial Media
                </p>
                <h3 className="card-title" id="desc-card">
                  Pengalaman Kerja
                </h3>
                <p className="card-text" id="desc-text">
                  <span>Product Designer Tokopedia ( 2020 - Sekarang )</span>
                  <span>UI/UX Designer Niagahoster ( 2018 - 2019 )</span>{" "}
                  <span>Freelance Graphic Designer ( 2017 )</span>{" "}
                  <span>Logo Designer Nico Studio ( 2016 )</span>
                </p>
              </div>
              <div className="container">
                <div className="row">
